...
def run_stage1_instrument(
    ...
    *,
    ...
    Capacity-Tariff:
      - track peak_imports_old / peak_exports_old NODE-SPECIFIC as dict[node] -> MW
      - reset those dicts at billing boundaries
      - update those dicts after each window from follower output columns:
            imports_power, exports_power  (MW, node-specific, repeated over t)
        (If your follower exports are named differently, adapt the column names below.)
    """
    print("\n==============================================")
